...
from phytoplankton_species_classifier import paths


module_name = 'phytoplankton_species_classifier'
...
def test_load():
    ...
    import phytoplankton_species_classifier.api


def test_metadata():
    print('Testing local: metadata ...')
    from phytoplankton_species_classifier.api import get_metadata
...
def test_predict_url():
    ...
    from phytoplankton_species_classifier.api import predict_url
...
def test_predict_data():
    ...
    from phytoplankton_species_classifier.api import predict_data
...
def test_train():
    ...
    from phytoplankton_species_classifier.api import get_train_args, train
