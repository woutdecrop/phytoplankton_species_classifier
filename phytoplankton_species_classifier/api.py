...
from phytoplankton_species_classifier import paths, utils, config, test_utils
from phytoplankton_species_classifier.data_utils import (
    load_class_names,
    load_aphia_ids,
    load_class_info,
    mount_nextcloud,
)
from phytoplankton_species_classifier.train_runfile import train_fn
...
def get_metadata(distribution_name="phytoplankton_species_classifier"):
    """
