...
pipeline {
    ...
    environment {
        author_name = "Decrop Wout"
        author_email = "wout.decrop@VLIZ.be"
        app_name = "phytoplankton_species_classifier"
        job_location = "Pipeline-as-code/DEEP-OC-org/UC-woutdecrop-DEEP-OC-phytoplankton_species_classifier/${env.BRANCH_NAME}"
    }
